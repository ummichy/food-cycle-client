...
const Banner = () => {
  return (
    ...
    >
      ...
      {/* Blur & gradient overlay with lighter blur */}
      <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/60 to-black/80 backdrop-blur-xs"></div>

      {/* Content */}
      <div className="relative z-10 max-w-5xl text-center px-6">
        <h1 className="text-white font-extrabold text-5xl sm:text-6xl md:text-7xl mb-4 leading-tight drop-shadow-xl animate-fadeInUp">
          Share Meals, <br />
          <span className="relative inline-block">
            Spread Happiness
            <span className="absolute left-0 -bottom-2 w-full h-1 bg-purple-500 rounded opacity-70 animate-underlineExpand"></span>
          </span>
        </h1>

        <p className="text-gray-300 text-lg sm:text-xl md:text-2xl font-light max-w-3xl mx-auto mb-12 drop-shadow-md animate-fadeInUp delay-150">
        ...
        <div className="flex justify-center gap-6 flex-wrap">
          <Link to="/available-foods" aria-label="Explore Available Foods">
            <button
              type="button"
              className="px-12 py-4 bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800 text-white font-semibold rounded-full shadow-lg hover:brightness-110 transition duration-300 focus:outline-none focus:ring-4 focus:ring-purple-400"
            >
          ...
          <Link to="/add-food" aria-label="Add Food Donation">
            <button
              type="button"
              className="px-12 py-4 border border-purple-600 text-purple-600 font-semibold rounded-full hover:bg-purple-600 hover:text-white transition duration-300 focus:outline-none focus:ring-4 focus:ring-purple-400"
            >
              Donate Food Now
            </button>
          </Link>
